...
#    print ('Test2222',x,forsage100[x]['nRedLight'])
    sheet.append([unixtime(starttime), unixtime(endtime),x,forsage100[x]['tSolidLine'],forsage100[x]['nRedLight'],forsage100[x]['nWrongDirection'],forsage100[x]['tRoadSide'],forsage100[x]['tStopLine'],forsage100[x]['tOneDirection'],forsage100[x]['nOverSpeed']])
